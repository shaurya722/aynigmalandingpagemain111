      ...
      {/* <div className="absolute inset-0" style={{ perspective: '1000px' }}>
        <div
          ...
          style={{
            ...
            animation: 'mesh-morph 20s ease-in-out infinite, float-3d 15s ease-in-out infinite',
            filter: 'blur(60px)',
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            animation: 'mesh-morph 25s ease-in-out infinite reverse, float-3d 18s ease-in-out infinite',
            filter: 'blur(80px)',
            animationDelay: '5s',
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            animation: 'mesh-morph 22s ease-in-out infinite, float-3d 20s ease-in-out infinite',
            filter: 'blur(70px)',
            animationDelay: '10s',
          }}
        />
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96">
          {[...Array(3)].map((_, i) => (
            <div
              ...
              style={{
                background: i === 0 ? 'var(--brand-primary)' : i === 1 ? 'var(--brand-accent)' : '#00d4ff',
                animation: `orbit ${15 + i * 5}s linear infinite`,
                animationDelay: `${i * 2}s`,
                filter: 'blur(2px)',
                boxShadow: `0 0 20px ${i === 0 ? 'var(--brand-primary)' : i === 1 ? 'var(--brand-accent)' : '#00d4ff'}`,
              }}
            />
          ))}
        </div>
          ...
          {[...Array(20)].map((_, i) => (
            <div
              ...
              style={{
                ...
                top: `${Math.random() * 100}%`,
                animation: `data-stream ${3 + Math.random() * 4}s ease-in-out infinite`,
