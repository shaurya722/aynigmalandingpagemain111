...
const features = [
  {
    icon: Target,
    title: 'Red Team Fuzzing',
    description:
      'Uncover vulnerabilities before attackers do with automated and guided fuzzing.',
    items: [
      'Jailbreak & injection coverage',
      'Custom policy packs',
      'Exportable reports',
    ],
  },
  {
    ...
    description:
      'Real-time classification, filtering, and policy enforcement across inputs/outputs.',
    items: [
  ...
  },
  {
    ...
    title: 'Agentic Radar',
    description:
      'Risk detection for autonomous & multi-agent systems with chain-of-thought hygiene.',
    items: ['Indirect injection alerts', 'Tool-use allowlists', 'Audit trails'],
  },
  {
    icon: FileText,
    title: 'Compliance & Risk Register',
    description:
      'Instantly map findings and controls to Saudi NCA Essential Cybersecurity Controls and PDPL.',
    items: ['NCA', 'ECC', 'PDPL'],
  },
]
...
export default function Product() {
  return (
    <section id='product' className='py-24 bg-[var(--surface)]/30'>
      <div className='container mx-auto px-6'>
        <div className='text-center mb-16'>
          ...
          <p className='text-sm text-[var(--brand-foreground-soft)] uppercase tracking-wider'>
            Runtime Safety • Red Team Fuzzing • Agentic Radar
          </p>
        </div>
